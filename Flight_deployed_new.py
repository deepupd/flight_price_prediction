...
import numpy as np
import pickle
encodes=pd.read_csv(r'C:\Users\deepu\Desktop\Python codes\Capstone Project\final_data.csv')
model=pickle.load(open(r'C:\Users\deepu\Desktop\Python codes\Capstone Project\flight_final.pkl','rb'))
